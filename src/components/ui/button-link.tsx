...
type ButtonVariant = "primary" | "secondary" | "tonal" | "ghost-icon";
...
const variants: Record<ButtonVariant, string> = {
  ...
  tonal:
    "btn btn-tonal inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold transition hover:-translate-y-1 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-indigo-500",
  "ghost-icon":
